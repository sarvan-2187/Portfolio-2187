    ...
    <footer className="relative z-0 overflow-x-clip">
      ...
      <div className="container py-6">
        <div className="border-t border-white/15 py-6 text-sm flex flex-col md:flex-row md:justify-between items-center">
          <div>
            <div className="font-sans bg-gradient-to-r from-emerald-300 to-sky-400 text-transparent bg-clip-text text-center"><span className="text-gray-100">&copy; Designed & Developed by </span>Sarvan Kumar</div>
          </div>
