...
const hobbies = [
  ...
  { title: "Competitive Programming", emoji: "💻", left: '25%', top: '48%' },
        ...
        <div className="mt-20 md:mt-6 flex flex-col gap-4 ">
          <div className="md:grid md:grid-cols-5 md:gap-8 lg:grid lg:grid-cols-3 flex flex-col gap-8">
            ...
            <Card className="h-[320px] p-0 md:col-span-3 lg:col-span-2">
              <CardHeader title="My Development Stack" description="Explore the curated collection of the tools and languages I work with." className="pt-6 px-6" />
